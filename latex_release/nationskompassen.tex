...
\label{sec: guide}
    ...
    \subsection{Förutsättningar}
        ...
        \begin{itemize}
            ...
            \item \textbf{nonce} -- nyckel för att hämta data från Nationsguiden behöver uppdateras senast 12 timmar innan körning (se \hyperref[subsec: felhantering]{\textit{2.7 Felhantering och vanliga problem}}).
        \end{itemize}
