...
\section{Programdokumentation}
    ...
    \subsection{Allmän design på programmet}
        ...
        \end{itemize}
        Strukturen i programmet är sekventiell. Under \textit{3.5 Kontrollflöde och hjälpfunktioner} finns det en mer djupgående förklaring på hur programets olika moduler samspelar samt en grafisk visualisation. 
